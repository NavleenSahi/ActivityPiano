...
public class MainActivity extends AppCompatActivity {
    ...
    private final String PARTICLE_USERNAME = "navleenk1@gmail.com";
    private final String PARTICLE_PASSWORD = "Rehmat25";

    // MARK: Particle device-specific info
    private final String DEVICE_ID = "230032000f47363333343437";
